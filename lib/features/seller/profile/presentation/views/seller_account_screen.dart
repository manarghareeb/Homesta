          ...
          child: Column(
            ...
            children: [
              ...
              OptionTile(
                ...
                label: 'Company Data',
                onTap: () {
                  GoRouter.of(context).push(AppRouter.companyDataScreen);
                },
              ),
              OptionTile(
              ...
              OptionTile(
                ...
                label: 'Product',
                onTap: () {
                  GoRouter.of(context).push(AppRouter.productScreen);
                },
              ),
              OptionTile(
                ...
                label: 'Analytics',
                onTap: () {
                  GoRouter.of(context).push(AppRouter.salesAnalyticsScreen);
                },
              ),
              SizedBox(height: 8.h),
              const Divider(),
