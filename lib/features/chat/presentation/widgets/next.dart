...
class nextChatButton extends StatefulWidget {
  final VoidCallback? onSwipeRight;
  final VoidCallback? onSwipeLeft;

  const nextChatButton({super.key, this.onSwipeRight, this.onSwipeLeft});

  @override
  State<nextChatButton> createState() => _StartChatButtonState();
}

class _StartChatButtonState extends State<nextChatButton>
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: EdgeInsets.only(right: 75.0, left: 25),
