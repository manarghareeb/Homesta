...
class ColorManager {
  ...
  static const Color startchatColor = Color(0xFF46B6BD);
  static const Color soLightGreyColor = Color(0xFFF6F6F6);
  ...
  static const Color whihte = Colors.white;

  static const Color lightGreyIconColor = Color(0xFFE0DFDF);
}
